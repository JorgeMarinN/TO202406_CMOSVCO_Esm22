...
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/stage_v1p1.sym} -310 -10 0 0 {name=x1}
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/stage_v1p1.sym} -120 -10 0 0 {name=x2}
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/stage_v1p1.sym} 70 -10 0 0 {name=x3}
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/stage_v1p1.sym} 260 -10 0 0 {name=x4}
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/stage_v1p1.sym} 450 -10 0 0 {name=x5}
...
C {devices/ipin.sym} -190 80 0 0 {name=p12 lab=VFIX}
