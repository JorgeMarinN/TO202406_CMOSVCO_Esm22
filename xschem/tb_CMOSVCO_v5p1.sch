...
wrdata /foss/designs/TO202406_CMOSVCO_Esm22/xschem/data/data_CMOSVCOlowG_v5p1.txt v(V_1) tran1.v(V_1) tran2.v(V_1) tran3.v(V_1) tran4.v(V_1) tran5.v(V_1) tran6.v(V_1) tran7.v(V_1) tran8.v(V_1) tran9.v(V_1) tran10.v(V_1) tran11.v(V_1) tran12.v(V_1) tran13.v(V_1) tran14.v(V_1) tran15.v(V_1) tran16.v(V_1) tran17.v(V_1) tran18.v(V_1) tran19.v(V_1)
...
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/Esm22_CMOSVCOlowG_v5p1.sym} 2980 -930 0 0 {name=x1}
