...
*197mA
*.param RL = 13
.save v(ldo_out) v(v_res) v(D1) v(D1_N) v(DOUT) v(VCONTr) v(VCONTs) v(V_1r_buff) v(V_1s_buff) v(V_1r_buff_sp) v(V_1s_buff_sp) v(DOUT) i(v5) i(v_res)
vvdd vdd 0 dc 3.3
vvss vss 0 0
...
.endc
"}
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/Esm22_CMOSVCO_v3p1.sym} 1590 -950 0 0 {name=xVREF}
...
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/Esm22_CMOSVCO_v3p1.sym} 1590 -1270 0 0 {name=xVSENS}
...
C {devices/lab_pin.sym} 2340 -1135 1 0 {name=p37 sig_type=std_logic lab=V_1s_buff_sp}
C {devices/lab_pin.sym} 2310 -1095 1 0 {name=p38 sig_type=std_logic lab=V_1r_buff_sp}
