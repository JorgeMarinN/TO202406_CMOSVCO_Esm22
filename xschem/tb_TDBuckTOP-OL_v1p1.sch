...
spice_ignore=false
place=header}
C {devices/code_shown.sym} 3240 -1020 0 0 {name=s1 only_toplevel=false value=".param VDIG = 1.8
.param VH = 5
*113mA
*.param RL = 26
*93mA
...
C {devices/lab_pin.sym} 1555 -210 2 1 {name=l14 sig_type=std_logic lab=D1_N_s
}
...
C {devices/lab_pin.sym} 1555 -620 2 1 {name=l5 sig_type=std_logic lab=D1_s
}
...
C {devices/lab_wire.sym} 1105 -580 0 1 {name=l8 sig_type=std_logic lab=D1_s}
C {devices/vsource.sym} 1095 -270 0 0 {name=V7 value="PULSE(0 1.8 200.0n 5n 5n 3000.0000000000005n 10000.0n)"}
C {devices/lab_pin.sym} 1105 -310 0 1 {name=l10 sig_type=std_logic lab=D1_N_s
}
C {devices/lab_wire.sym} 1085 -230 0 0 {name=l13 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1085 -500 0 0 {name=l16 sig_type=std_logic lab=VSS}
C {devices/vsource.sym} 1095 -540 0 0 {name=V10 value="PULSE(0 1.8 0n 5n 5n 3400.0000000000005n 10000.0n)"}
