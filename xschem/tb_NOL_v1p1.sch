...
C {devices/vsource.sym} -240 -210 0 0 {name=VIN value="PULSE(0 1.8 11u 10n 10n 12u 24u)"}
...
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/NOL_v1p1.sym} 180 -160 0 0 {name=x1}
