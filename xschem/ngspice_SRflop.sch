...
.model dsrflop d_srff(ic=0 rise_delay=1n fall_delay=1n)

AA2D1 [A_GND] [d_gnd] todig_3v3

AA2D2 [A_S] [d_s] todig_3v3
AA2D3 [A_R] [d_r] todig_3v3
AA2D4 [A_CLK] [d_clk] todig_3v3

A1 d_s d_r d_clk d_gnd d_gnd d_out NULL dsrflop
...
C {devices/ipin.sym} 180 -150 0 0 {name=p4 lab=A_CLK}
