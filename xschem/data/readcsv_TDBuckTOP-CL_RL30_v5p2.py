...
df=pd.read_fwf('data_TDBuckTOP-CL_v5p2_RL30.txt',infer_nrows = 1000)
df.to_csv('data_TDBuckTOP-CL_v5p2_RL30.csv', index=False)
data = pd.read_csv("data_TDBuckTOP-CL_v5p2_RL30.csv").values
