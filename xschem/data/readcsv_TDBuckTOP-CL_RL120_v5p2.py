...
df=pd.read_fwf('data_TDBuckTOP-CL_v5p2_RL120.txt',infer_nrows = 1000)
df.to_csv('data_TDBuckTOP-CL_v5p2_RL120.csv', index=False)
data = pd.read_csv("data_TDBuckTOP-CL_v5p2_RL120.csv").values
...
i_cut = 250000
x_ih = data[i_cut:num_rows,0]
y_ih = data[i_cut:num_rows,1]
x_vout = data[i_cut:num_rows,2]
y_vout = data[i_cut:num_rows,3]
x_iout = data[i_cut:num_rows,4]
y_iout = data[i_cut:num_rows,5]
