...
df=pd.read_fwf('data_TDBuckTOP-CL_v5p3_RL120.txt',infer_nrows = 1000)
df.to_csv('data_TDBuckTOP-CL_v5p3_RL120.csv', index=False)
data = pd.read_csv("data_TDBuckTOP-CL_v5p3_RL120.csv").values
...
x_igd = data[i_cut:num_rows,10]
y_igd = [-1]*data[i_cut:num_rows,11]
...
print("potencia de VH_GD:",pgd, "[W]")


print("eficiencia:", eff ,"[%]")
print("eficiencia con GD:", effgd ,"[%]")
