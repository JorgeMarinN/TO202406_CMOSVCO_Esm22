...
va_clk a_clk 0 pulse 0 3.3 6n 0.1n 0.1n 25n 50n
*va_clk a_clk 0 dc 0
.control
save all
tran 0.2n 1100n 
write test_ngspice_SRflop.raw
.endc
" }
...
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/ngspice_SRflop.sym} 380 -140 0 0 {name=x2}
C {devices/ipin.sym} 90 -320 0 0 { name=p11 lab=A_CLK}
C {devices/lab_pin.sym} 230 -130 0 0 {name=p12 lab=A_CLK}
