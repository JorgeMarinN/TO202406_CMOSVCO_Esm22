...
N 3005 -1160 3005 -1140 { lab=GND}
N 3005 -1270 3005 -1220 { lab=VH}
N 1555 -400 1585 -400 {
lab=VDIG}
N 1885 -400 1905 -400 {
lab=VH}
...
N 1585 -360 1585 -350 {
lab=VSS}
N 3115 -1160 3115 -1140 { lab=GND}
N 3115 -1270 3115 -1220 { lab=VDIG}
N 2700 -250 2700 -210 {
lab=VSS}
N 2470 -580 2470 -540 {
lab=GND}
...
.endc
"}
C {Esm22_CMOSVCOlowG_v4p2.sym} 1590 -950 0 0 {name=xVREF}
...
C {Esm22_CMOSVCOlowG_v4p2.sym} 1590 -1270 0 0 {name=xVSENS}
...
C {BUFFMIN_v1p2.sym} 1640 -1290 0 0 {name=X2}
C {BUFFMIN_v1p2.sym} 1640 -970 0 0 {name=X3}
...
C {devices/vsource.sym} 3005 -1190 0 0 {name=VH value=\{VH\}}
C {devices/gnd.sym} 3005 -1140 0 0 {name=l23 lab=GND}
C {devices/lab_wire.sym} 3005 -1270 0 0 {name=l24 sig_type=std_logic lab=VH}
C {devices/lab_wire.sym} 1555 -400 0 0 {name=l4 sig_type=std_logic lab=VDIG}
C {devices/lab_pin.sym} 1925 -360 0 1 {name=l6 sig_type=std_logic lab=D1_N
}
...
C {devices/lab_wire.sym} 1545 -350 0 0 {name=l31 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1905 -420 0 1 {name=l36 sig_type=std_logic lab=VH
}
C {LS_FINAL.sym} 1735 -620 0 0 {name=x4}
C {LS_FINAL.sym} 1735 -380 0 0 {name=x5}
C {devices/vsource.sym} 3115 -1190 0 0 {name=V8 value=\{VDIG\}}
C {devices/gnd.sym} 3115 -1140 0 0 {name=l1 lab=GND}
C {devices/lab_wire.sym} 3115 -1270 0 0 {name=l2 sig_type=std_logic lab=VDIG}
...
C {devices/res.sym} 2470 -610 0 0 {name=RL
value=\{RL\}
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} 2470 -730 0 0 {name=Vldo_out value=0}
C {devices/gnd.sym} 2470 -540 0 0 {name=l52 lab=GND}
C {devices/lab_pin.sym} 2470 -800 2 0 {name=p24 sig_type=std_logic lab=ldo_out

}
C {devices/lab_pin.sym} 2470 -800 2 0 {name=p25 sig_type=std_logic lab=ldo_out

}
C {devices/res.sym} 2690 -710 0 0 {name=RDIV1
value=100e6
footprint=1206
device=resistor
m=1}
C {devices/res.sym} 2690 -590 0 0 {name=RDIV2
value=100e6
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 2690 -520 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} 2690 -780 2 0 {name=p26 sig_type=std_logic lab=ldo_out

}
C {devices/lab_pin.sym} 2690 -780 2 0 {name=p27 sig_type=std_logic lab=ldo_out

}
C {devices/lab_pin.sym} 2690 -645 2 0 {name=p28 sig_type=std_logic lab=VCONTs}
C {devices/lab_pin.sym} 1365 -620 0 0 {name=p30 sig_type=std_logic lab=DOUT}
C {BUFFMIN_v1p2.sym} 1355 -620 0 0 {name=X6}
...
C {devices/lab_pin.sym} 1365 -380 0 0 {name=p29 sig_type=std_logic lab=DOUT}
C {BUFFMIN_v1p2.sym} 1355 -380 0 0 {name=X7}
C {devices/lab_pin.sym} 1430 -320 3 0 {name=p32 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1430 -440 1 0 {name=p35 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1485 -380 1 0 {name=p36 sig_type=std_logic lab=DOUT_D1_N}
...
C {short_pulse_generator.sym} 2005 -970 0 0 {name=x8}
C {short_pulse_generator.sym} 2005 -1290 0 0 {name=x9}
