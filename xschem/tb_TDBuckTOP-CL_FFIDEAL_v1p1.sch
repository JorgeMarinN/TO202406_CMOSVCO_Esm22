...
N 1460 -210 1585 -210 {
lab=DOUT_D1_N}
N 2725 -1450 2765 -1450 {
lab=V_1s_buff}
N 2725 -1430 2765 -1430 {
lab=V_1r_buff}
N 2735 -1410 2765 -1410 {
lab=VDD}
N 2735 -1390 2765 -1390 {
lab=VSS}
N 3065 -1440 3095 -1440 {
lab=#net4}
N 3130 -1500 3130 -1470 {
lab=VDD}
N 3130 -1410 3130 -1380 {
lab=VSS}
...
plot i(v5)
plot i(r3)
plot v(D1) v(D1_N)+5 v(v_res)+15 i(v5)+18
.endc
"}
...
C {devices/lab_pin.sym} 3215 -1440 1 0 {name=p15 sig_type=std_logic lab=DOUT}
...
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/ngspice_flop.sym} 2915 -1420 0 0 {name=x1}
C {devices/lab_pin.sym} 2725 -1450 1 0 {name=p37 sig_type=std_logic lab=V_1s_buff}
C {devices/lab_pin.sym} 2725 -1430 1 0 {name=p38 sig_type=std_logic lab=V_1r_buff}
C {devices/lab_pin.sym} 2735 -1410 0 0 {name=p39 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 2735 -1390 0 0 {name=p40 sig_type=std_logic lab=VSS}
C {/foss/designs/TO202406_CMOSVCO_Esm22/xschem/INVMIN_v1p1.sym} 3055 -1440 0 0 {name=X8}
C {devices/lab_pin.sym} 3130 -1500 1 0 {name=p11 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 3130 -1380 3 0 {name=p12 sig_type=std_logic lab=VSS}
