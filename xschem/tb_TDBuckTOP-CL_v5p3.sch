...
N 3080 -180 3080 -145 {
lab=VCONTs}
N 2580 -640 2580 -620 { lab=GND}
N 2580 -750 2580 -700 { lab=VH_GD}
...
*15mA
*.param RL = 120
.save v(ldo_out) v(v_res) v(D1) v(D1_N) v(DOUT) v(VCONTr) v(VCONTs) v(V_1r_buff) v(V_1s_buff) v(V_1r_buff_sp) v(V_1s_buff_sp) v(DOUT) v(vh) i(vh) v(vh_gd) i(vh_gd) i(v_res) v(VCONTs_OL) v(vcp) v(vcn) i(vldo_out) i(vvdig) i(vvdd)
vvdd vdd 0 dc 3.3
vvss vss 0 0
...
C {devices/lab_pin.sym} 1905 -660 0 1 {name=l125 sig_type=std_logic lab=VH_GD
}
...
C {devices/lab_pin.sym} 1905 -250 0 1 {name=l36 sig_type=std_logic lab=VH_GD
}
...
C {devices/lab_pin.sym} 3080 -160 2 0 {name=p28 sig_type=std_logic lab=VCONTs}
...
device=resistor
m=1}
C {devices/vsource.sym} 2580 -670 0 0 {name=VH_GD value=\{VH\}}
C {devices/gnd.sym} 2580 -620 0 0 {name=l8 lab=GND}
C {devices/lab_wire.sym} 2580 -750 0 0 {name=l9 sig_type=std_logic lab=VH_GD}
